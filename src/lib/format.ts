...
export function money(pence: number, opts: { compact?: boolean } = {}) {
...
export const PLAN_PRICE_PENCE = { monthly: 1200, yearly: 12000 } as const;
export type Plan = keyof typeof PLAN_PRICE_PENCE;
...
export function splitPayment(amountPence: number, charityPercent: number) {
