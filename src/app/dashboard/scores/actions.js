...
function readable(message, code) {
  if (code === "23505")
    return "You've already logged a score for that date. Edit it instead.";
...
function validate(value, playedOn) {
 ...
 * repeating it.
 */
export async function addScore(_prev, formData) {
...
export async function updateScore(_prev, formData) {
