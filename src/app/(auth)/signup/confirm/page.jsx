  ...
  return (
    <>
      ...
      <p className="mt-3 text-sm leading-relaxed text-paper-300">
        We&apos;ve sent you a confirmation link. Click it and you&apos;ll be able to sign
        in and pick your cause.
      </p>
      <p className="mt-4 text-sm leading-relaxed text-ink-500">
        Nothing there after a minute or two? Check spam — confirmation mail has a habit of
        ending up there.
      </p>
